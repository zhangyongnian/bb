  ...
  <div class="container exchange" :class="skin">
    ...
    <div class="main">
      ...
      <div class="right">
        <div class="coin-menu">
          <div class="sc_filter">
            <span @click="changeBaseCion('qc')" :class="{active:basecion==='qc'}" style="width:34%">QC</span>
            <span @click="changeBaseCion('usdt')" :class="{active:basecion==='usdt'}" style="width:24%">USDT</span>
            <span @click="changeBaseCion('btc')" :class="{active:basecion==='btc'}" style="width:21%">BTC</span>
            <span @click="changeBaseCion('eth')" :class="{active:basecion==='eth'}" style="width:21%">ETH</span>
          ...
          <Table @on-current-change="gohref" highlight-row id="QC" v-show="basecion==='qc'" :columns="coins.columns" :data="coins.QC"></Table>
...
export default {
  ...
  methods: {
    ...
    startWebsock() {
      ...
      var that = this;
      var socket = new SockJS("http://47.75.35.234:9595" + that.api.market.ws);
