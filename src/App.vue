  ...
  <div :class="pageView">
    <div class="page-content">
      <div class="time_download">
        ...
        <a href="http://www.dogex.pro/#/helpdetail?cate=0&id=2&cateTitle=%E6%96%B0%E6%89%8B%E6%8C%87%E5%8D%97">{{$t("header.appdownlaod")}}</a>
    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          <img src="./assets/images/small_logo.png" style="margin:0;width:100px;height:40px;"></img>
          <!-- <h3>Caymanex.Pro</h3> -->
          <p>{{$t("footer.gsmc")}}</p>
        ...
        <div class="footer_right">
          ...
          <ul>
            <li class="footer_title">
              <span><a href="http://www.dogex.pro/#/notice/index?id=1" >{{$t("footer.lxwm")}}</a></span>
            </li>
            <!--<li class="wechatclick">
              <poptip width="200">
                <a href="javascript:;" class="wechat">客服邮箱</a>
                <div slot="content">
                  <p style="text-align:center;">yuanheng@yhliz.com</p>
                </div>
              </poptip>
            </li>-->
            <!-- <li>
    ...
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          break;
        default:
          window.document.title = "DogEX.PRO 全球领先区块链|虚拟币|数字资产交易平台";
          break;
      }
    },
    $route(to, from) {
