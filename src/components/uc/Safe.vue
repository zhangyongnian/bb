                ...
                <div class="user-top-icon">
                   ...
                   <!-- <Row class="user-right">
                        ...
                        <div class="itp" v-else>{{$t('uc.safe.safelevel_medium')}}</div>
					        ...
					        <div class="user-icons">
                        <div class="user-face user-avatar-public">
                            <span class="user-avatar-in">DGRO</span>
                        </div>
                        <div class="user-name" style="line-height:52px">
                            <span style="line-height:52px">{{user.bccash}}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p v-if="user.realVerified==1" class="bankInfo" style="color: #fff;">{{user.realName}}</p>
                                ...
                                <p v-else class="bankInfo" style="color: #fff;">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p v-if="user.phoneVerified==1" class="bankInfo" style="color: #fff;">
                                    {{user.mobilePhone}}
                                </p>
                                <p v-else class="bankInfo" style="color: #fff;">
                                    {{$t('uc.safe.bindphone')}}
