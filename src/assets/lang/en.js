module.exports = {
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become BCCOIN Certified Business and enjoy more transaction privileges",
    ...
    description: {
        ...
        // message3: 'BCCOIN Exchange supports 10,00 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'BCCOIN international digital encryption asset trading platform mobile client, focusing on palm trading experience',
    },
    footer: {
    ...
    index: {
        ...
        BHBregister: "BCCOIN account registration",
        ...
        fenpeijizhi: 'A description of the BCCOIN income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, BCCOIN will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
