module.exports = {
    ...
    uc: {
        ...
        regist: {
            ...
            recommandtip: '请输入推荐码',
            recommandmsg: '推荐手机号码格式不正确,请重新输入',
            countrytip: '请选择国家',
            smscodetip: '请输入短信验证码',
            pwdtip: '请输入登录密码',
            pwdmsg: '密码长度不能少于6位',
    ...
    description: {
        ...
        // message3: 'DogEX数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '安全',
        title2: '快捷',
        title3: '体验',
        ...
        message5: 'DogEX国际数字加密资产交易平台手机客户端，专注掌上交易体验',
    },
    footer: {
        wechatkefu: "微信客服",
        notice: '平台公告',
    ...
    index: {
        ...
        BHBregister: "DogEX账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于DogEX收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，DogEX会拿出平台的80% (扣除税费后) 的收入分配给DogEX持有者，20%的收入用来支持平台的研发及运营。",
